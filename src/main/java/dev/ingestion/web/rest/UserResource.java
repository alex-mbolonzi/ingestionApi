...
import dev.ingestion.config.Constants;
import dev.ingestion.domain.User;
import dev.ingestion.repository.UserRepository;
import dev.ingestion.security.AuthoritiesConstants;
import dev.ingestion.service.MailService;
import dev.ingestion.service.UserService;
import dev.ingestion.service.dto.AdminUserDTO;
import dev.ingestion.web.rest.errors.BadRequestAlertException;
import dev.ingestion.web.rest.errors.EmailAlreadyUsedException;
import dev.ingestion.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link dev.ingestion.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
